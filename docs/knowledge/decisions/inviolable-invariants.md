...
any git process runs**. The remote must also be a plain, already-configured
name; flag-shaped values and arbitrary URLs cannot become Git options. The handle it runs on is hardened like every other
