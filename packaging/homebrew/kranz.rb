...
# and runs `cargo install`. The placeholders below are filled at release
...
#                curl -sL https://github.com/craigcode/kranz/archive/refs/tags/vVERSION.tar.gz | shasum -a 256
#
# Ship it via a tap (e.g. `brew tap craigcode/kranz && brew install kranz`) or a
...
class Kranz < Formula
  ...
  url "https://github.com/craigcode/kranz/archive/refs/tags/v0.1.0.tar.gz"
  version "0.1.0"
