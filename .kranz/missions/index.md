...
- 2026-07-19 · [m-0f1abd](m-0f1abd/plan.md) — Record model provenance (id, quant, weight-hash) on every run and add a derived, event-log-regenerable export that yield… [truncated]
