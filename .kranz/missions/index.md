...
- 2026-07-05 · [m-8b7db0](m-8b7db0/plan.md) — Add an opt-in `kranz otel --endpoint <otlp>` sidecar that tails mission event logs and exports OpenTelemetry spans (miss… [truncated]
