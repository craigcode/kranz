...
The overhead figures are aarch64 measurements and directly attest the native
Windows ARM64 release artifact. The boundary assertions are OS mechanisms
shared with x86_64; protected hosted CI separately proves that production path.
