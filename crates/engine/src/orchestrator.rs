...
use crate::command_exec::{
    is_git_repo, last_chars_local, run_shell_command, run_with_timeout, tail_chars,
};
use crate::config;
...
use crate::report_render::{
    extract_research, render_mission_report, render_plan_markdown, render_research_markdown,
